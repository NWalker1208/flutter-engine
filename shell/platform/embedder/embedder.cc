...
FlutterEngineResult FlutterEngineSendPointerEvent(
  ...
  for (size_t i = 0; i < events_count; ++i) {
    ...
    pointer_data.pressure = SAFE_ACCESS(current, pressure, 1.0);
    pointer_data.pressure_min = SAFE_ACCESS(current, pressure_min, 1.0);
    pointer_data.pressure_max = SAFE_ACCESS(current, pressure_max, 1.0);
